...
<body>
  ...
  <div class="layui-btn-container">
    ...
    <button class="layui-btn layui-btn-sm" lay-event="getCheckData" id="remove">下架</button>
  </div>
	...
	<script type="text/javascript">
		...
		layui.use([ 'table', 'form' ], function() {
			...
			 //获取选中数量
				...
				$.ajax({
					url:"/nverhong/Product?action=delete&id="+str,
					type:"get",
			...
			$("#remove").on('click',function(){
				...
				if(selectCount == 0){
					...
					      str = checkStatus.data[i].id;
					$.ajax({
						url:"/nverhong/ProductOffShelf?action=ProductoffShelf&id="+str,
						type:"get",
						contentType : "application/x-www-form-urlencoded;charset=UTF-8",
						data :{"str":str},
					success:function(data){
			...
			function getGoodsList(paramstr) {
				...
				table.render({
					...
					url : '/nverhong/Product?action=getAllProduct&' + paramstr, //数据接口
